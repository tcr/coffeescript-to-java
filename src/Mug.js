...
function compile() { 
window.Mug = {scopes: [], classes: [], numbers: {}, props: {}};
var coffee = CoffeeScript.compile(document.getElementById('input').value, {no_wrap: true, scope_level: -1});
...
data += "final CSScope" + scope.level + " s" + scope.level + " = new CSScope" + scope.level + "();\n";
}
...
for (var i = 0; i < Mug.scopes.length; i++) {
var s = Mug.scopes[i];
scopes += "\tstatic class CSScope" + s.level + (s.level == 0 ? " extends CSScopeRoot" : "") + " {\n\t\tpublic void clean() { ";
var a = "";
...
/*
	static public class CSObject_0 extends CSObject {
		public CSObject_0() { }
		public CSObject_0(CSObject proto) { __proto__ = proto; }
		
		CSPrimitive _first;
		public CSPrimitive get_first() {
			if (_first != null) return _first;
			if (__proto__ == null) return null;
			return __proto__.get_first();
		}
		public void set_first(CSPrimitive v) { _first = v; }
*/
